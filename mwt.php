                                                        ...
                                                        <div class="col-sm-4" >
                                                            <div class="card" style="background:rgba(0,255,0,0.5)">
                                                                <div class="card-body text-center">
                                                                    ...
                                                                    <a href="" data-backdrop="false" data-toggle="modal" class="btn btn-success" onclick="shape_handler('pm25','all_pm25','line')">Run</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-4">
                                                            <div class="card" style="background:rgba(255,0,0,0.5)">
                                                                <div class="card-body text-center">
                                                                    <h5 class="card-title">PM 1</h5>
                                                                    <p class="card-text">Polygons</p>
                                                                    <a href="#" class="btn btn-danger" onclick="shape_handler('pm1','all_pm1','polygon')">Run</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-4">
        ...
        if(method == "line"){
            ...
            $.get('mwt_handler.php', example, function(data){ // ajax call to populate pavement lines
                for(index in data.shape_arr){ // iterates through every index in the returned element (data['shape_arr'])
                    ...
                    polygon.setMap(map);
                    //polygons["pm1"].push(polygon); // could store into global array for easy/fast erasing and re-populating
                }
            });
        }
